...
#@JOSUE:                              I DONT KNOW HOW TO TURN THIS INTO AN ARRAY OF PREDICTIONS!!!!!
...
#from random state 0 through 9 (inclusive), add to final csv file
for i in range(10):
    random_state = i
    ...
    #add the various models as collumns to the csv and then open again on next loop
